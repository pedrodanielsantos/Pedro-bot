...
- **Music**: queue-based playback from YouTube, YouTube Music, SoundCloud and
  Bandcamp through a self-hosted Lavalink node, with Spotify and Tidal links
  matched to a YouTube or SoundCloud stream, plus opt-in search suggestions,
  seeking, looping and an optional DJ role.
